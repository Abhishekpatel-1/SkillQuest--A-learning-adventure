...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "gradient-primary text-primary-foreground shadow-game hover:shadow-glow hover:scale-105 active:scale-95",
        ...
        gold: "gradient-gold text-accent-foreground shadow-gold hover:shadow-lg hover:scale-105 active:scale-95",
        success: "gradient-success text-success-foreground shadow-md hover:shadow-lg hover:scale-105 active:scale-95",
        game: "bg-card border-2 border-border text-foreground shadow-game hover:border-primary hover:shadow-glow transition-all",
      },
      size: {
